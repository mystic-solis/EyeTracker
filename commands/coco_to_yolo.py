...
from utils.ImageElement import ImageElement
...
def dataset(**kwargs):
    """ Конвертирование датасета из формата COCO в формат YOLO """
    ...
    for annotation_file in annotation_files:
        ...
        annotated_images = set([entry['file_name'].split("/")[-1] for entry in coco_data['images']])
